...
MODULE ocean_tl_ad_integrator

  USE ocean_util, only: init_one
  USE ocean_params, only: ndim, natm, noc
  USE ocean_tensor, only: sparse_mul3
  USE ocean_aotensor_def, only: aotensor

  USE ocean_tl_ad_tensor, only: ad,tl,jacobian_mat
...
END MODULE ocean_tl_ad_integrator
